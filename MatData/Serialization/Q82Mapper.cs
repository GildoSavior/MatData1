    ...
    public static class Q82Mapper
    {
        public static Q82Model Serialize(Q82Record model)
        {
            return new Q82Model
            {
                ...
                ValCredSectorAnoCorr = double.Parse(model.q8228),
                ValCredSectorUltimos5Anos = double.Parse(model.q8229),
                ...
                CustosExtraccaoMPUnTMPE = double.Parse(model.q8243),
                ValVendaMPUnTMPE = double.Parse(model.q8254),
                PrecoComercializacaoUnTMPE = double.Parse(model.q8255),
                ...
                DespesasMensais = double.Parse(model.q8261),
                ReceitasMensais = double.Parse(model.q8262),
                LucroMensal = double.Parse(model.q8263),
                ContabilidadeOrganizada = model.q8264,
                VolumeNegocios = model.q8264 == "Sim" ? double.Parse(model.q8265) : 0,
                SituacaoTributRegularizada = model.q8264 == "Sim" ? model.q8266 : null,
                ValorLiqImpostos = model.q8264 == "Sim" ? double.Parse(model.q8267) : 0,
